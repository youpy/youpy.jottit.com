* 男の乳首=女のままでいられなかった駄目な人間たちの印
* セルフパブリッシング=自費出版
* ポタアン=ポータブルヘッドホンアンプ
* OC=おいしい
* リセマラ=ゲームを何度もインストールし直して、スタート時のレアガチャで良いものが出るまで繰り返すこと。リセットマラソンの略
* リバプロ=Reverse Proxy
* オーディオファイル=オーディオ愛好家
* コードV=吐いてしまったひとがいる
* Ego Depletion=頑張ろうという気持ちを使い切った、憔悴しきった状態。
* Yak Shaving=面倒で意味のなさそうな作業をさせられているが、実は他のいくつかのタスクと関連があり、それらが大きな目的を達成するために緩くつながっている様。
* セルカン=セルフカウンセリング
